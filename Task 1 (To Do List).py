...
if __name__ == "__main__":  
    ...
    guiWindow.geometry("650x400+200+80")  
    # disabling the resizable option  
    guiWindow.resizable(0, 0)  
    # setting the background color to #EE1289 
    guiWindow.configure(bg = "#EE1289")   
    ...
    functions_frame = Frame(guiWindow, bg = "Dark Violet") 
    ...
    add_button =Button(  
        ...
        text = "Add Task",  
        width = 15,
        bg='#D4AC0D',font=("Times New Roman", "14", "bold"),
        command = task,
